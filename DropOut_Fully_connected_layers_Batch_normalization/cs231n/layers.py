...
def batchnorm_forward(x, gamma, beta, bn_param):
    ...
    if mode == 'train':
        ...
        cache = (xmu, var, sqrtvar, ivar, x_hat, gamma, eps)
...
def batchnorm_backward(dout, cache):
    ...
    xmu, var, sqrtvar, ivar, x_hat, gamma, eps = cache
    N, D = dout.shape
...
def batchnorm_backward_alt(dout, cache):
    ...
    dx, dgamma, dbeta = np.zeros(dout.shape), np.zeros(gamma.shape), np.zeros(gamma.shape)
